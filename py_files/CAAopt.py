...
class AA(object):
    ...
    def cluster_loader(self,fraction=0.5):
        assert self.cluster_cut in [1000 ]
        ...
        self.cluster_start_end_dates_df = pd.read_csv('clusters_start_end_dates.csv', #self.cluster_dates_path + s2 + '_cut.csv',
    ...
    def AA_return(self):
        ...
        res, omegaAA, r = calculator_probas_sleeping2(self.dapra[cols3].values, self.dapra[cols].values,
                                                      ...
                                                      self.aa_rho, self.aa_rhobis, self.aa_u, self.aa_ubis,self.beta_sigmoid,self.power)
    ...
    def run_paper_scaling_factor(self, lossname, max_scaling, cluster_resolution=0):
        ...
        saveto = "leak_nottruemean_scalling_fullsleeping_nohier_" +  "_loss_" + lossname + "_clusterresolution_" + str(
            cluster_resolution) + "_cutoff_" + str(self.cluster_cut)
